...
int set_opencl_handle(void** cl_handle);
int open_opencl_so(const char *path, void** cl_handle);
void close_opencl_so(void **cl_handle);

// Legacy functions from previous project
__unused void stubOpenclReset();
__unused void reset_opencl_so();
...
typedef cl_int (*f_clCreateSubDevices)(cl_device_id, const cl_device_partition_property *, cl_uint, cl_device_id *,
                                       cl_uint *);
...
typedef cl_context (*f_clCreateContext)(const cl_context_properties *, cl_uint, const cl_device_id *, f_pfn_notify,
                                        void *, cl_int *);

typedef cl_context (*f_clCreateContextFromType)(const cl_context_properties *, cl_device_type, f_pfn_notify, void *,
                                                cl_int *);
...
typedef cl_program (*f_clCreateProgramWithBinary)(cl_context, cl_uint, const cl_device_id *, const size_t *,
...
typedef cl_program (*f_clLinkProgram)(cl_context, cl_uint, const cl_device_id *, const char *, cl_uint,
                                      const cl_program *, void (*pfn_notify)(cl_program program, void *user_data),
                                      void *, cl_int *);
...
typedef cl_int (*f_clEnqueueReadImage)(cl_command_queue, cl_mem, cl_bool, const size_t *, const size_t *, size_t,
                                       size_t, void *, cl_uint, const cl_event *, cl_event *);

typedef cl_int (*f_clEnqueueWriteImage)(cl_command_queue, cl_mem, cl_bool, const size_t *, const size_t *, size_t,
...
typedef void *(*f_clEnqueueMapBuffer)(cl_command_queue, cl_mem, cl_bool, cl_map_flags, size_t, size_t, cl_uint,
...
typedef cl_int (*f_clEnqueueNativeKernel)(cl_command_queue, void (*user_func)(void *), void *, size_t, cl_uint,
...
typedef cl_mem (*f_clCreateImage2D)(cl_context, cl_mem_flags, const cl_image_format *, size_t, size_t, size_t, void *,
                                    cl_int *);

typedef cl_mem (*f_clCreateImage3D)(cl_context, cl_mem_flags, const cl_image_format *, size_t, size_t, size_t, size_t,
                                    size_t, void *, cl_int *);
...
typedef cl_int (*f_clEnqueueAcquireGLObjects)(cl_command_queue, cl_uint, const cl_mem *, cl_uint, const cl_event *,
                                              cl_event *);

typedef cl_int (*f_clEnqueueReleaseGLObjects)(cl_command_queue, cl_uint, const cl_mem *, cl_uint, const cl_event *,
                                              cl_event *);
...
typedef cl_int (*f_clGetGLContextInfoKHR)(const cl_context_properties *, cl_gl_context_info, size_t, void *, size_t *);
