...
int set_opencl_handle(void **cl_handle) {
  if (*cl_handle) so_handle = *cl_handle;
  else return -1;
  return 0;
}
...
clEnqueueMigrateMemObjects(cl_command_queue command_queue,
  ...
  if (func) {
	return func(command_queue, num_mem_objects, mem_objects, flags, num_events_in_wait_list, event_wait_list,
				event);
  } else {
	return CL_INVALID_PLATFORM;
  }
